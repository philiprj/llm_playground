...
# data
dataset = "edu_fineweb10B"  # "openwebtext"
...
max_iters = 10000  # total number of training iterations (600000)
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
# CLI overide of the default config
config_keys = [k for k, v in globals().items() if not k.startswith("_") and isinstance(v | (int, float, bool, str))]
# Check if config.py exists in the current directory or the script's directory
